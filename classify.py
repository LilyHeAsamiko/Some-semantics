...
data = pd.read_csv(r'D:/PhD in Oxford,Ethz,KI,others/OxfordPhD/Arena/preproc1_expl_1.train.txt', sep = "\.\;\/n", nrows = 1000, dtype = str, engine = 'python')
